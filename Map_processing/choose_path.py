...
#path imported by google eath. external = external outline google_earth .kml points, 
#Inputs internal = internal outline google_earth .kml points, N_angle = numer of angle assesments over the trajectory 
#Output scipy spline and derivative, outlines 2d vectors left and right, 1d vector angle assessments angle.
def google_earth_path(external,internal,N_angle):
    ...
    #coords= reduce_points(right,left) #use if inner and outer lines have different number of points
...
#Inputs: name, external and internal .kml if existent, N_angles number of assessment points for angles
#Output scipy spline and derivative, outlines 2d vectors left and right, 1d vector angle assessments angle.
