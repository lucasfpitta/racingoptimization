...
def create_friction_circle_cones(x,F_1t,F_2t,n_discretization,m,mu,n_wheels):
...
def optimization_SOCP_b_3(R_t,M_t,C_t,A_t,n_discretization,xsi,n_wheels,display):
